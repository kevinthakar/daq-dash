...
import time
import pigpio
from collections import deque # http://abyz.co.uk/rpi/pigpio/python.html
...
If your code does not use the Linux SPI driver
Switch off spi in raspi-config and try again.
"""
max_length = 500
temp = []
temp_dict = { "Thermocouple 1": temp}
pi = pigpio.pi()
...
def tc1():
    sensor = pi.spi_open(0, 1000000, 0) # CE2 on auxiliary SPI
